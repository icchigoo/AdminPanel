...
class _DashboardState extends State<Dashboard> {
  ...
  // _getData() {
  //   var piedata = [
  //     Task('Girls', 35.8, Color(0xff3366cc)),
  //     Task('Women', 8.3, Color(0xff990099)),
  //     Task('Pants', 10.8, Color(0xff109618)),
  //     Task('Formal', 15.6, Color(0xfffdbe19)),
  //     Task('Shoes', 19.2, Color(0xffff9900)),
